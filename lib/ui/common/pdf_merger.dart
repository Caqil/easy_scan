...
/// A reusable component to handle PDF merging functionality
class PdfMerger {
  /// Show a bottom sheet to select a merge option
  static void showMergeOptions(
    ...
    showModalBottomSheet(
      ...
      builder: (context) => _MergeOptionsSheet(
...
class _MergeOptionsSheet extends ConsumerWidget {
