...
import 'package:pdf_render/pdf_render.dart' as rednder;
...
class ThumbnailService {
  ...
  Future<File?> _generatePdfThumbnail(String pdfPath, int size) async {
    try {
      ...
      final document = await rednder.PdfDocument.openFile(pdfPath);
      ...
      final pageImage = await page.render(
        ...
        height: (size * 2 * page.height / page.width).toInt(),
      );
      ...
      // Save as thumbnail
      final thumbnailPath = await FileUtils.getUniqueFilePath(
