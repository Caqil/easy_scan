...
class StorageService {
  ...
  /// Get directory containing app data for backup
  Future<String> getBackupAppDirectory() async {
    final appDocDir = await getApplicationDocumentsDirectory();
  ...
  Future<void> saveLastBackupDate(DateTime date) async {
    try {
      ...
      await box.put('last_backup_timestamp', date.millisecondsSinceEpoch);
      logger.info('Saved last backup date: $date');
    } catch (e) {
